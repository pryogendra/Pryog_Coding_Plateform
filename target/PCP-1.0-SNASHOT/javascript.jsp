    ...
    <div class="container">
        ...
        <form action="submitcode.jsp" method="post">
            ...
            <select id="question" name="question" onchange="showTextBox()">
                ...
                <%
                    try
                    {
                        ...
                        ResultSet rs= stmt.executeQuery("select javascript_tasks from tasks where javascript_tasks is not null");
                        while (rs.next()){
                        %>
                            <option value="<%=rs.getString("javascript_tasks")%>"><%=rs.getString("javascript_tasks")%></option>
                        <%
            ...
            <div id="textboxContainer" class="textbox-container">
                <textarea id="textbox" name="textbox_javascript" placeholder="Type your code here..."></textarea><br><br>
            </div>
