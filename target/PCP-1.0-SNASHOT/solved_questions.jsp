...
<body>
    ...
    <%
        try {
            ...
            String query = "SELECT * FROM users_data WHERE username = ?";
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    out.println("<p><strong>"+code_type+" Code:</strong> <textarea id='autoResizeTextArea'>"+ answer + "</textarea><p>");
                }
            }
            if(chk!=1){
                out.println("<p><center><strong style='color:red;'>No any code submitted by you....</strong></center></p>");
            }
            else {
                out.println("<p><center><strong style='color:red;'>No more code submitted by you.</strong></center></p>");
            }
            rs.close();
            ps.close();
            conn.close();
