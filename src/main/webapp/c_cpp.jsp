    ...
    <div class="container">
        ...
        <form action="submitcode.jsp" method="post">
            ...
            <select id="question" name="question" onchange="showTextBox()">
                ...
                <%
                    try
                    {
                        ...
                        ResultSet rs= stmt.executeQuery("select cpp from tasks where cpp is not null");
                        while (rs.next()){
                        %>
                            <option value="<%=rs.getString("cpp")%>"><%=rs.getString("cpp")%></option>
                        <%
            ...
            <div id="textboxContainer" class="textbox-container">
                <textarea id="textbox" name="textbox_cpp" placeholder="Type your code here..."></textarea><br><br>
            </div>
