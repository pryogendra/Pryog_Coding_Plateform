    ...
    <div class="container">
        ...
        <form action="submitcode.jsp" method="post">
            ...
            <select id="question" name="question" onchange="showTextBox()">
                ...
                <%
                    try
                    {
                        ...
                        ResultSet rs= stmt.executeQuery("select c_sharp_tasks from tasks where c_sharp_tasks is not null");
                        while (rs.next()){
                        %>
                            <option value="<%=rs.getString("c_sharp_tasks")%>"><%=rs.getString("c_sharp_tasks")%></option>
                        <%
            ...
            <div id="textboxContainer" class="textbox-container">
                <textarea id="textbox" name="textbox_c_sharp" placeholder="Type your code here..."></textarea><br><br>
            </div>
