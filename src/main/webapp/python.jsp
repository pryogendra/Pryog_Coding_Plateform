    ...
    <div class="container">
        ...
        <form action="submitcode.jsp" method="post">
            ...
            <select id="question" name="question" onchange="showTextBox()">
                ...
                <%
                    try
                    {
                        ...
                        ResultSet rs= stmt.executeQuery("select python_tasks from tasks where python_tasks is not null");
                        while (rs.next()){
                        %>
                            <option value="<%=rs.getString("python_tasks")%>"><%=rs.getString("python_tasks")%></option>                       
                        <%
            ...
            <div id="textboxContainer" class="textbox-container">
                <textarea id="textbox" name="textbox_python" placeholder="Type your code here..."></textarea><br><br>
            </div>
